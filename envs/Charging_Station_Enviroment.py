...
class ChargingEnv(gym.Env):
    ...
    def reset(self, reset_flag=0):
        ...
        if reset_flag == 0:
            [BOC, ArrivalT, DepartureT, evolution_of_cars, present_cars, ReqEnergy] = Init_Values.InitialValues_per_day(self)
            self.Invalues = {'BOC': BOC, 'ArrivalT': ArrivalT, 'evolution_of_cars': evolution_of_cars,
                             'DepartureT': DepartureT, 'present_cars': present_cars, 'ReqEnergy': ReqEnergy}
            ...
            self.Invalues = {'BOC': contents['BOC'], 'Arrival': contents['ArrivalT'][0],
                             ...
                             'present_cars': contents['present_cars'],  'ReqEnergy': contents['ReqEnergy'], 'ArrivalT': [], 'DepartureT': []}
